...
import { Category, FormatListNumbered, GroupAdd, HdrAuto, North, Schedule, South } from '@mui/icons-material';
import { isCharacterNpc } from '../Helpers/isCharacterNpc';
import { RemoveNameCR } from '../Helpers/RemoveNameCR';

export const CreateGroupModal = (parent) => {
    ...
    return(
        <Box border="4px outset" borderRadius="10px" borderColor={Colors.groupColor} sx={modalStyle} p="15px">
